...
export default function Navbar () {
  return (
    <>
    <div className=' z-[999] h-30 w-full flex items-center bg-slate-50/10 pt-4 text-3xl text-nav-300 mb-4 border-8 border-indigo-600 sticky bg-gray-100 top-0 left-0'>
